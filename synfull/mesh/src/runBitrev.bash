...
declare -a strArr=("meshBitrev")
#declare -a strArr=("mesh8Hotspot" "meshHotspot" "meshUniform" "meshTranspose" "meshTornado" "meshBitComp" "meshShuffle" "meshBitrev")
